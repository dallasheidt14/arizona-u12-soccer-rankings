#!/usr/bin/env python3
"""
Scrape ALL U11 teams in the exact format: team_name, gotsport_team_id, state
"""
import requests
import pandas as pd
...
def main():
    print("Scraping ALL U11 teams...")
    print("Format: team_name, gotsport_team_id, state (like FL:1, NJ:1)")
    ...
    print(f"\nSUCCESS!")
    print(f"Scraped {len(df)} U11 teams")
