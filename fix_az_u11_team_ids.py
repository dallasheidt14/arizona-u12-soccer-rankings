#!/usr/bin/env python3
"""
Fix the Arizona U11 teams by scraping the correct team_id field
"""
import requests
import pandas as pd
import time
...
def fix_az_u11_teams():
    """Re-scrape Arizona U11 teams with the correct team_id field"""
    print("Re-scraping Arizona U11 teams with correct team_id...")
    ...
    # Save corrected Arizona teams
    timestamp = datetime.now().strftime("%Y%m%d_%H%M%S")
    output_file = f"data/master/U11 2015 BOYS MASTER TEAM LIST/by_state/AZ_teams_CORRECTED_{timestamp}.csv"
