#!/usr/bin/env python3
"""
Debug similarity calculation step by step
"""
...
def debug_similarity_step_by_step():
    """Debug similarity calculation step by step"""
    print("=== DEBUGGING SIMILARITY CALCULATION STEP BY STEP ===")
