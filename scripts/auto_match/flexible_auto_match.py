#!/usr/bin/env python3
"""
Flexible Auto-Match Script
==========================

This script will automatically add Team B State, Club, and GotSport ID
by matching against your master team lists.

It will look for your U10 and U11 data files and process them automatically.
"""
...
def find_data_files():
    """Find U10 and U11 data files."""
    
    print("Searching for U10 and U11 data files...")
    
    # Look for files with U10 or U11 in the name
    u10_files = []
    u11_files = []
    ...
    for root, dirs, files in os.walk('.'):
        for file in files:
            if file.lower().endswith('.csv'):
                ...
                if 'u10' in file.lower() and 'game' in file.lower():
                    u10_files.append(file_path)
                elif 'u11' in file.lower() and 'game' in file.lower():
                    u11_files.append(file_path)
    
    print(f"Found U10 files: {u10_files}")
    print(f"Found U11 files: {u11_files}")
    
    return u10_files, u11_files
...
def main():
    ...
    print("=== FLEXIBLE AUTO-MATCH TEAM B DATA ===")
    ...
    # Find data files
    u10_files, u11_files = find_data_files()
    ...
    if u10_files:
        ...
        for u10_file in u10_files:
            try:
                print(f"Processing {u10_file}...")
                u10_enhanced = auto_match_team_b(u10_file, 10)
        ...
        print("❌ No U10 data files found")
    
    # Process U11 data
    if u11_files:
        print(f"\n=== PROCESSING U11 DATA ===")
        for u11_file in u11_files:
            try:
                print(f"Processing {u11_file}...")
                u11_enhanced = auto_match_team_b(u11_file, 11)
