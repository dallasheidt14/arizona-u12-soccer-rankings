...
# Output file names
MATCHED_GAMES_FILE = "data/processed/Matched_Games.csv"
...
def main():
    ...
    try:
        master_df = pd.read_csv("data/input/AZ MALE U12 MASTER TEAM LIST.csv")
        games_df = pd.read_csv("data/input/AZ MALE U12 GAME HISTORY LAST 18 MONTHS .csv")
