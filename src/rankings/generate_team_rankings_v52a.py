# rankings/generate_team_rankings_v52a.py
"""
ARIZONA U12 RANKING LOGIC — V5.2a (Stability Fixes)
...
7. Output Rankings_v52a.csv sorted by PowerScore
"""
import pandas as pd
import numpy as np
import os
...
# ---- V5.2a Tuning Parameters (Stability Fixes) ----
OFF_WEIGHT = 0.35
DEF_WEIGHT = 0.35
SOS_WEIGHT = 0.30
...
if __name__ == "__main__":
    # Example CLI usage:
    # python -m rankings.generate_team_rankings_v52a --in Matched_Games.csv --out Rankings_v52a.csv
    import argparse
    p = argparse.ArgumentParser()
    p.add_argument("--in", dest="in_path", required=True)
    p.add_argument("--out", dest="out_path", default="Rankings_v52a.csv")
    args = p.parse_args()
